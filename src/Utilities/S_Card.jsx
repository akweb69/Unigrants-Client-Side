    ...
    return (
        <div className="w-full border h-full p-4 rounded-xl flex flex-col justify-between hover:shadow-md bg-white">
            ...
            <div className="w-full text-center pt-5 pb-1 ">
                <Link className="w-full inline-block p-3 text-center border rounded-lg bg-gradient-to-tr from-orange-500 to-orange-500 hover:from-orange-500 hover:to-fuchsia-500 text-white font-logoFont text-base md:text-lg" to={"/"}> Scholarship Details</Link>
            </div>
